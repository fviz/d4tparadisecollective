                                                            ...
                                                            <tr>
                                                                <td style="font-size:6px;line-height:10px;padding:0px 0px 0px 0px;"
                                                                    ...
                                                                    <img class="max-width" border="0"
                                                                         ...
                                                                         src="https://d4tparadise.com/assets/finalll_big.png"
                                                                         alt="" width="120">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding:18px 0px 18px 0px;line-height:22px;text-align:inherit;"
                                                                    ...
                                                                    valign="top"
                                                                    bgcolor="">
                                                                    <div>Thank you for reserving tickets! You
                                                                        got {{ $ticket->amount }} ticket(s) for
                                                                        €{{ $ticket->price }} each.
                                                                    </div>

                                                                    <div>&nbsp;</div>

                                                                    <div>We will see you on April 22nd, from 8:30PM, at
                                                                        Nieuwe Kade 2 Arnhem. The bar only accepts cash,
                                                        ...
                                                        <table class="module" role="module" data-type="text" border="0"
                                                            ...
                                                            <tr>
                                                                <td style="padding:18px 0px 18px 0px;line-height:22px;text-align:inherit;"
                                                                    ...
                                                                    bgcolor="">
                                                                    <div><span
                                                                            style="color: rgb(0, 0, 0); font-family: arial; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400;">By the way, your ticket ID is {{ $ticket->uuid }}.</span>
                                                                    </div>
